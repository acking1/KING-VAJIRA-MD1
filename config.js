...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("919564704717")
...
global.gurl = 'Akash_Creation_002' // add your username
global.sudo = process.env.SUDO || '919564704717'
global.devs = '919564704717';
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Âkâßh 𝐁𝐨𝐭' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Âkâßh Pâglâ' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'vajira' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'Âkâßh-Md' : process.env.PACK_INFO.split(";")[1],
